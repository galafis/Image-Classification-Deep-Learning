...
class TestBirdClassification(unittest.TestCase):
    ...
    def test_alexnet_model_instantiation(self):
        ...
        model = AlexNet(num_classes=20).to(self.device)
        self.assertIsInstance(model, AlexNet)
        self.assertEqual(model.classifier[6].out_features, 20)
    ...
    def test_alexnet_forward_pass(self):
        ...
        self.assertEqual(output.shape, (1, 20)) # Saída deve ser (batch_size, num_classes)
